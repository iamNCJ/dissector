...
if __name__ == '__main__':
    ...
    for name in ['BE', 'BIM', 'DeepFool', 'Dropout-SIA', 'FGSM', 'PGD', 'SIA', 'Dropout-SIA-4', 'Dropout-SIA-4-Targeted', 'PGD-Targeted', 'SIA-Targeted', 'SIA-4-Targeted', 'SIA-8-Targeted', 'Dropout-SIA-8-Targeted']:
        print(name)
